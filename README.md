...
| week4 | 2022.10.05 | 1. [URL 입력, 렌더링 과정, 네트워크 프로토콜과 주소, URI vs URL vs URN, 웹 캐시](https://github.com/shinhee-rebecca/2022-cs-study/blob/week4-1/Network/URL%20입력%2C%20렌더링%20과정%2C%20네트워크%20프로토콜과%20주소%2C%20URI%20vs%20URL%20vs%20URN%2C%20웹%20캐시.md)<br />2. HTTP 특징, HTTP 1,2,3의 차이, HTTP 상태코드 <br />3. 쿠키와 세션, 캐시, JWT <br />4. HTTP vs HTTPS, SSL 동작방식, TLS 동작방식, HSTS |
