...
| week1 | 2022.09.14 | 1. [Deadlock, Race Condition, 세마포어&뮤텍스](https://github.com/shinhee-rebecca/2022-cs-study/blob/main/Operating%20System/Deadlock%2C%20Race%20Condition%2C%20세마포어%26뮤텍스.md) <br />2. 가상 메모리, 요구페이징, 페이지 교체 알고리즘 <br />3. 프로세스 vs 스레드, 멀티스레드, 스케줄러, CPU스케줄러<br />4. 메모리 관리 전략(페이징, 세그멘테이션) |
